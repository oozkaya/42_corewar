...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/12/13 15:56:26 by oozkaya           #+#    #+#             */
/*   Updated: 2019/02/26 18:21:10 by ade-verd         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
** @brief: Executes all the "lldi" operations according to the parameters
**
** @param env: Context structure
** @param proc: Processors structure
*/
...
void		ft_lldi(t_env *env, t_proc *proc)
{
	...
	if (proc->working && !proc->charge)
	{
		...
		verbose_intro(env, "lldi", proc->nbr);
		proc->pc += 2;
