...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/11/30 13:19:15 by oozkaya           #+#    #+#             */
/*   Updated: 2019/03/05 18:19:22 by oozkaya          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
** @brief: Subtracts the content of the 1st and 2nd regsiters into the 3rd one
**
...
/*
** @brief: Executes all the "sub" operations according to the parameters
**
** @param env: Context structure
** @param proc: Processors structure
*/
...
void		ft_sub(t_env *env, t_proc *proc)
{
	...
	if (proc->working && !proc->charge)
	{
		...
		verbose_intro(env, "sub", proc->nbr);
		proc->pc += 2;
		regs_part(env, proc);
